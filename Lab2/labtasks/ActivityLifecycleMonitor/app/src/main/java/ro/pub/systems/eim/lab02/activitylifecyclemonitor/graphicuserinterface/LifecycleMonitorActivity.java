...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            Log.d(Constants.TAG, "onCreate() 1 method was invoked without a previous state");
        } else {
            Log.d(Constants.TAG, "onCreate() 2 method was invoked without a previous state");
        }
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        //EditText usernameEditText = (EditText)findViewById(R.id.username_edit_text);
        //String old_txt = savedInstanceState.getString(Constants.USERNAME_EDIT_TEXT);
        //usernameEditText.setText(old_txt + "13");
